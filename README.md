...
Trade-offs: simple interpretable models vs complex high-performance models
In a regulated financial context, there is a fundamental trade-off between model interpretability and predictive power:
